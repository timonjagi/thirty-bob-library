    ...
    return (
      <div className="flex flex-col w-full h-full">
        ...
        <div className="flex-1 flex flex-col items-center justify-center px-30px">
          <div className="text-green-600 text-48px mb-20px">✓</div>
          <h4 className="font-semibold text-18px text-gray-900 mb-10px text-center">Request Submitted!</h4>
          <p className="text-gray-600 text-14px text-center mb-30px">
            We've received your book request. We'll notify you when it's available.
          </p>
          <button
            onClick={hideRequest}
  ...
  return (
    <div className="flex flex-col w-full h-full">
      ...
      <div className="flex-1 overflow-y-auto px-30px py-30px">
        ...
        {status === 'error' && (
          <div className="bg-red-50 border border-red-200 text-red-700 text-14px px-16px py-12px rounded mb-20px">
            {errorMsg}
          </div>
        )}
